...
const conf_reg_map_st conf_reg_map_inst[CONF_REG_MAP_NUM] = {
    ...
    {44, &g_sys.config.ComPara.u16Sterilize_Interval[0], 1, 10000, 360, 2, 1, NULL},
    ...
    {48, &g_sys.config.ComPara.u16NormalWater_Temp, 0, 400, 250, 2, 1, NULL},
    {49, &g_sys.config.ComPara.u16HotWater_Temp, 0, 1000, 80, 2, 1, NULL},
    {EE_EXITWATER, &g_sys.config.ComPara.u16ExitWater_Mode, 0, 3, 0, 2, 1, NULL},
    {EE_DISINFECTION, &g_sys.config.ComPara.u16Disinfection_Mode, 0, 1, 0, 2, 1, NULL},
    {52, &g_sys.config.ComPara.u16Sterilize_Mode, 0, 3, 1, 2, 1, NULL},
    {53, &g_sys.config.ComPara.u16Sterilize_Time[1], 1, 600, 10, 2, 1, NULL},
    {54, &g_sys.config.ComPara.u16Sterilize_Interval[1], 1, 10000, 360, 2, 1, NULL},
    ...
    {65, &g_sys.config.alarm[ACL_FILTER_ELEMENT_0_OT].alarm_param, 1, 65535, 3600, 2, 1, NULL},
    ...
    {71, &g_sys.config.ComPara.u16Fan_Stop_Delay, 1, 300, 30, 1, 1, NULL},
    {72, &g_sys.config.ComPara.u16Comp_Interval, 5, 600, 10, 2, 1, NULL},
    ...
    {94, &g_sys.config.alarm[ACL_E17].alarm_param, 0, 30, 6, 2, 1, NULL},
    ...
    {115, &g_sys.config.ComPara.u16Heater_PM25, 0, 2, 0, 2, 1, NULL},
    ...
    {126, &g_sys.config.ComPara.u16CycleTime, 0, 24, 9, 2, 1, NULL},
    ...
    {140, &g_sys.config.ComPara.j25LoopInterval, 0, 24, 3, 0, 1, NULL},
    {141, &g_sys.config.ComPara.j25LoopTime, 0, 30, 20, 0, 1, NULL},
    {142, &g_sys.config.ComPara.j25ChildLockTime, 0, 10, 10, 0, 1, NULL},
    {143, &g_sys.config.ComPara.j25MaxEffluentTime, 0, 10, 3, 0, 1, NULL},
    {144, &g_sys.config.ComPara.j25CombinationKeyTime, 0, 10, 5, 0, 1, NULL},
    {145, &g_sys.config.ComPara.j25IdelAutoCleanInterval, 0, 10, 7, 0, 1, NULL},
    ...
    {153, &g_sys.config.ComPara.j25OutwardFanSecondGearTempreture, 70, 100, 90, 0, 1, NULL},
    {154, &g_sys.config.ComPara.j25OutwardFanStopTempreture, 40, 69, 50, 0, 1, NULL},
    {155, &g_sys.config.ComPara.j25ExhaustWarnTempreture, 100, 135, 115, 0, 1, NULL},
    {156, &g_sys.config.ComPara.j25ExhaustWarnRelieveTempture, 50, 80, 65, 0, 1, NULL},
    {157, &g_sys.config.ComPara.j25OutwardFanFirstGear, 0, 100, 30, 0, 1, NULL},
    {158, &g_sys.config.ComPara.j25OutwardFanSecondGear, 0, 100, 50, 0, 1, NULL},
    {159, &g_sys.config.ComPara.j25InsideFanOutput, 0, 100, 30, 0, 1, NULL},
...
static void init_load_status(void)
{
    ...
    //		l_sys.u32WaterFlow=g_sys.status.ComSta.u16Cumulative_Water[1];
    //		l_sys.u32WaterFlow<<=16;
    //		l_sys.u32WaterFlow+=g_sys.status.ComSta.u16Cumulative_Water[0];
}
